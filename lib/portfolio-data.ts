...
export const projects: readonly Project[] = [
  {
    ...
    stack: "Next.js / FastAPI / pgvector / Gemini 3.5",
    ...
    overview:
      "Dream Veil is an AI-powered dream journaling platform built around contextual interpretation and semantic pattern recognition. Users record dreams, receive streaming psychoanalysis from user-selectable Gemini 3.5/2.5 Flash models with configurable thinking depth and optional multimodal image analysis, and discover thematic links across their history all while optional E2EE ensures the server never permanently stores plaintext narratives or interpretations.",
    ...
    highlights: [
      "Architected the Blind Vault a 4-phase zero-knowledge E2EE handshake across REST and SSE with a 5-phase resumable batch migration state machine for large libraries.",
      "Built a 6-phase production RAG pipeline: hybrid pgvector + BM25 retrieval, reciprocal rank fusion, cross-encoder reranking, grounding guards, and tiered chronological context assembly.",
      "Streamed multimodal AI interpretations via Server-Sent Events with BYOK Gemini keys, Redis-backed RAG context caching, and intelligent API key rotation with tiered TTL exhaustion handling.",
    ],
    metrics: [
  ...
  },
  {
    ...
    number: "02",
    title: "NEXT PGP",
    category: "PGP Cryptography",
    stack: "Next.js / Auth.js / Hero UI / OpenPGP",
  ...
  },
  {
    ...
    stack: "Next.js 15 / Prisma / GSAP / Auth.js",
    image: dimitrescuWallpapersHero,
    href: "https://dimitrescuwallpapers.vercel.app",
    tagline:
      "A cinematic Resident Evil Village fan gallery with 416 routes, model-viewer SCPs, and scroll-driven motion across every homepage section.",
    overview:
      "Dimitrescu Wallpapers is a large-scale fan gallery and PWA for Bela, Cassandra, and Daniela Dimitrescu from Resident Evil Village. It spans 416 statically routed pages 298 gallery hubs and leaves across portrait, landscape, and edited hierarchies, plus 112 model-viewer SCP variant pages. Two hundred sixty-eight leaf galleries pair Masonry layout with GLightbox one-click downloads and GitHub API-driven wallpaper inventories, each with per-page OpenGraph, Twitter Card, and JSON-LD metadata. The homepage layers a Framer Motion parallax carousel, GSAP ScrollTrigger sections (featured photos, Castle Dimitrescu, pinned horizontal story slider, mods, previews), Character.ai, Wattpad, Nexus Mods, and YouTube integrations, plus an authenticated review system backed by Auth.js and PostgreSQL.",
    ...
    highlights: [
      "Built 416 statically routed pages (298 gallery + 112 model-viewer) with per-route OpenGraph, Twitter Card, and JSON-LD metadata plus directory-based sitemap generation.",
      "Implemented 268 masonry GLightbox leaf galleries with GitHub API wallpaper feeds, dual preloader systems (Framer Motion + legacy GSAP), Lenis smooth scroll, and GSAP ScrollTrigger homepage choreography.",
      "Shipped an Auth.js review system (Google, GitHub, Discord) with Prisma persistence, IP-based PostgreSQL rate limiting, malicious-input validation, and PWA offline caching via Workbox.",
    ],
    metrics: [
      { label: "Routes", value: "416" },
...
export const services: readonly Service[] = [
  ...
  },
  {
    ...
    description:
      "Building scalable SaaS platforms with Next.js, FastAPI, and PostgreSQL from async REST APIs to real-time SSE streaming systems.",
